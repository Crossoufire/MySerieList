...
from MyLists.medialists.functions import check_list_type, get_medialist_data, set_last_update, compute_time_spent, \
...
from MyLists.models import User, Movies, MoviesActors, MoviesGenre, Series, SeriesGenre, SeriesList, \
    ...
    AnimeList, ListType, SeriesActors, MoviesList, Status


bp = Blueprint('medialists', __name__)

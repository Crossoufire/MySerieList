...
from MyLists.models import User, Friend, Series, SeriesList, SeriesEpisodesPerSeason, SeriesGenre, SeriesNetwork, SeriesEpisodeTimestamp, Anime, AnimeEpisodesPerSeason, AnimeEpisodeTimestamp, AnimeGenre, AnimeList, AnimeNetwork
...
class SeriesListAdminView(ModelView):
    ...
    column_list = ('user_id', 'series_id', 'current_season', 'last_episode_watched', 'status')
...
class AnimeListAdminView(ModelView):
    ...
    column_list = ('user_id', 'anime_id', 'current_season', 'last_episode_watched', 'status')
...
admin.add_view(UserAdminView(model=User, session=db.session, name="User", endpoint='user'))
admin.add_view(FriendAdminView(model=Friend, session=db.session, name="Friend", endpoint='friend'))

admin.add_view(SeriesAdminView(model=Series, session=db.session, name="Series", endpoint='series'))
admin.add_view(SeriesListAdminView(model=SeriesList, session=db.session, name="Series list", endpoint='series_list'))
admin.add_view(SeriesEpisodesPerSeasonAdminView(model=SeriesEpisodesPerSeason, session=db.session, name="Series episodes per season", endpoint='series_episodes_per_season'))
admin.add_view(SeriesGenreAdminView(model=SeriesGenre, session=db.session, name="Series genre", endpoint='series_genre'))
admin.add_view(SeriesNetworkAdminView(model=SeriesNetwork, session=db.session, name="Series network", endpoint='series_network'))
admin.add_view(SeriesEpisodeTimestampAdminView(model=SeriesEpisodeTimestamp, session=db.session, name="Series episode timestamp", endpoint='series_episode_timestamp'))

admin.add_view(AnimeAdminView(model=Anime, session=db.session, name="Anime", endpoint='anime'))
